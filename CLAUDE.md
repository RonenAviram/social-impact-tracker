...
- **ארגון "אחר":** שדה טקסט חופשי לשם ארגון, נשמר ב-custom_org_name. מוצג רק כשם הארגון (ללא קידומת "אחר")
...
- ✅ admin-campaign: תאריכי ברירת מחדל דינמיים (היום + 7 ימים)
- ✅ ארכיון קישורים: שם+ארגון בשורה עליונה, סוג+תאריך למטה
- ✅ 42 בדיקות — 41 עברו, 1 פער ידוע (עיתון מודפס דורש קישור — לא רגרסיה)
- 🔄 UAT עם מיכל פרינס — מתנסה, ממתינים להערות
- ✅ עדכון training-package.html (הרשמה עצמית, כניסה חוזרת, השהיה, ארגון "אחר", הסרת מסך הצלחה, קישור אופציונלי, ארכיון קישורים)
